...
<div class="sidebar-gov">
    ...
    <a href="/peluang-gs" class="{{ request()->is('peluang-gs*') ? 'active' : '' }}">
        <i class="bi bi-briefcase"></i> Peluang Proyek GS
    </a>
    <a href="/data-wilayah-gs" class="{{ request()->is('data-wilayah-gs*') ? 'active' : '' }}">
        <i class="bi bi-geo-alt"></i> Wilayah
    </a>
    <a href="/aktivitas-marketing" class="{{ request()->is('aktivitas-marketing*') ? 'active' : '' }}">
