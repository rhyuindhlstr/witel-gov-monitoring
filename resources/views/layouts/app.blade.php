...
<head>
    ...
    <title>@yield('title', 'SSGS Monitoring') - Telkom Witel Lampung-Bengkulu</title>
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-header">
            <a href="{{ route('home') }}" class="sidebar-brand text-decoration-none">
                <div class="logo-wrapper">
                    <img src="{{ asset('img/telkom-original.png') }}" alt="Telkom Indonesia" style="width: 90px; height: auto;">
                </div>
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('pelanggan.index') }}" class="nav-link {{ request()->routeIs('pelanggan.*') ? 'active' : '' }}" title="Data Pelanggan">
                <i class="bi bi-building"></i>
                <span>Data Pelanggan</span>
            </a>
            <a href="{{ route('kunjungan.index') }}" class="nav-link {{ request()->routeIs('kunjungan.*') ? 'active' : '' }}" title="Kunjungan">
                <i class="bi bi-calendar-check"></i>
                <span>Kunjungan</span>
            </a>
            <a href="{{ route('pembayaran.index') }}" class="nav-link {{ request()->routeIs('pembayaran.*') ? 'active' : '' }}" title="Pembayaran">
        ...
        <div class="sidebar-user">
            ...
            <div class="sidebar-user-info">
                ...
                <p class="sidebar-user-role">Marketing SSGS</p>
            </div>
        </div>
        @endauth
    </div>
            ...
            <div class="header-actions">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end shadow border-0 mt-2" style="width: 320px;">
                        <div class="d-flex justify-content-between align-items-center px-3 py-2 border-bottom">
                            ...
                            <a href="#" onclick="event.preventDefault(); document.getElementById('mark-read-form').submit();" class="text-decoration-none small text-danger">Mark all as read</a>
                            <form id="mark-read-form" action="{{ route('notifications.markRead') }}" method="POST" class="d-none">
                                @csrf
                            </form>
                        </div>
                        <div class="list-group list-group-flush" style="max-height: 300px; overflow-y: auto;">
                            <!-- Payment Reminder -->
                            <a href="{{ route('pembayaran.show', 1) }}" class="list-group-item list-group-item-action px-3 py-3 border-bottom-0">
                                <div class="d-flex align-items-start">
                                    <div class="bg-warning bg-opacity-10 text-warning rounded-circle p-2 me-3 d-flex align-items-center justify-content-center" style="width: 32px; height: 32px; min-width: 32px;">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-1 small text-muted">Tagihan Dinas Pendidikan akan jatuh tempo dalam 3 hari (25 Jan 2026).</p>
                            ...
                            <!-- Visit Schedule -->
                            <a href="{{ route('kunjungan.show', 1) }}" class="list-group-item list-group-item-action px-3 py-3 border-bottom-0">
                                <div class="d-flex align-items-start">
                                    <div class="bg-danger bg-opacity-10 text-danger rounded-circle p-2 me-3 d-flex align-items-center justify-content-center" style="width: 32px; height: 32px; min-width: 32px;">
                                        <i class="bi bi-calendar-event-fill" style="font-size: 0.9rem;"></i>
                                    </div>
                                    <div>
                                        <p class="mb-1 small fw-bold text-dark">Jadwal Kunjungan</p>
                                        <p class="mb-1 small text-muted">Anda memiliki jadwal kunjungan ke Dinas Kesehatan pukul 10:00 WIB.</p>
                            ...
                            <a href="{{ route('pembayaran.show', 1) }}" class="list-group-item list-group-item-action px-3 py-3 border-bottom-0">
                                <div class="d-flex align-items-start">
                                    <div class="bg-success bg-opacity-10 text-success rounded-circle p-2 me-3 d-flex align-items-center justify-content-center" style="width: 32px; height: 32px; min-width: 32px;">
                                        <i class="bi bi-check-circle-fill" style="font-size: 0.9rem;"></i>
                                    </div>
                                    <div>
                                        <p class="mb-1 small fw-bold text-dark">Pembayaran Diterima</p>
                                        <p class="mb-1 small text-muted">Pembayaran dari Dinas PU sebesar Rp 50.000.000 telah lunas.</p>
                             ...
                             <a href="{{ route('pelanggan.show', 1) }}" class="list-group-item list-group-item-action px-3 py-3">
                                <div class="d-flex align-items-start">
                                    <div class="bg-danger bg-opacity-10 text-danger rounded-circle p-2 me-3 d-flex align-items-center justify-content-center" style="width: 32px; height: 32px; min-width: 32px;">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-1 small text-muted">Dinas Perhubungan belum dikunjungi dalam 30 hari terakhir.</p>
                        ...
                        <div class="text-center p-2 border-top">
                            <a href="{{ route('notifications.index') }}" class="small text-decoration-none fw-bold text-danger">View All Notifications</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="dropdown">
                    <a href="#" class="d-flex align-items-center text-decoration-none" data-bs-toggle="dropdown" aria-expanded="false">
                        @auth
                            <div class="header-profile-img text-white d-flex align-items-center justify-content-center fw-bold" style="font-size: 0.9rem; background-color: var(--telkom-red);">
                                {{ strtoupper(substr(Auth::user()->name, 0, 1)) }}
                            </div>
                        @else
                            <div class="header-profile-img bg-secondary text-white d-flex align-items-center justify-content-center">
