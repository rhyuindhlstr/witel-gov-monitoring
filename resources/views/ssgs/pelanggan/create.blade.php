                    ...
                    <form action="{{ route('pelanggan.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('wilayah_id') is-invalid @enderror" id="wilayah_id"
                                name="wilayah_id" required style="color: #000; background-color: #fff;">
                                <option value="" style="color: #000; background-color: #fff;">Pilih Wilayah</option>
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="small text-muted mb-2">Field yang wajib diisi ditandai dengan <span
                            class="text-danger">*</span></p>
                    <hr>
                    <ul class="small text-muted mb-0">
                        <li>Pastikan data pelanggan sudah benar</li>
                        <li>Nomor telepon harus aktif untuk komunikasi</li>
                        <li>Email opsional tapi disarankan diisi</li>
                    </ul>
                </div>
            </div>
        </div>
