    ...
    <div class="col-md-6">
        <div class="card shadow-sm border-0">
            <div class="card-body text-center py-5">
                <div class="mb-4">
                    <div class="d-inline-flex align-items-center justify-content-center text-white rounded-circle shadow-sm" style="width: 100px; height: 100px; font-size: 2.5rem; font-weight: bold; background-color: var(--telkom-red);">
                        {{ strtoupper(substr($user->name, 0, 1)) }}
                    </div>
                </div>
                
                <h3 class="font-weight-bold text-dark mb-1">{{ $user->name }}</h3>
                <p class="text-muted mb-4">Marketing SSGS</p>
                ...
                <div class="text-start px-md-5">
                    ...
                    <div class="alert alert-danger d-flex align-items-center mb-0" role="alert">
                        ...
                        <div class="small">
                            This account is managed by the administrator. To update your information or password, please contact IT Support.
                        </div>
                    </div>
                </div>
            </div>
